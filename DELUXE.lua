...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖤓│[تحديثات البوت](t.me/jx8xj) \n𖤓│[قناه السورس](t.me/SD_SN)')
end
...
usertext = '*\n 𖤓│اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'jx8xj')..')'
status  = '\n *𖤓│تم ترقيته مطور*'
...
usertext = '\n *𖤓│اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'jx8xj')..')'
status  = '\n*𖤓│تم ترقيته مطور*'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *𖤓│اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'jx8xj')..') \n 𖤓│'..SNAPCHAT1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *𖤓│العضو :* {["..data.first_name_.."](t.me/jx8xj)}\n𖤓│["..SNAPCHAT_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *𖤓│عذرا ⇎* {["..data.first_name_.."](t.me/jx8xj)}\n*𖤓│عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
data = JSON.decode(url)
Text = "𓅛 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ᴠᴇɴᴏᴍ \n\n[𖤓│ᴠᴇɴᴏᴍ ᴄʜᴀɴɴᴇʟ](http://t.me/SD_SN)\n\n[𖤓│ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/jx8xj)\n\n[𖤓│ᴠᴇɴᴏᴍ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/xritc)\n\n[𖤓│ᴛᴡ ʙᴏᴛ ](http://t.me/IOlIIbot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓅛︙ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ',url="t.me/jx8xj"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, '*𖤓│بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'jx8xj')..') \n*𖤓│تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *𖤓│بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'jx8xj')..') \n*𖤓│تـم قفـل التاك بالكتم* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖤓│العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'jx8xj')..')'
status  = '\n*𖤓│تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *𖤓│لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'jx8xj')..')'
status  = '\n*𖤓│تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *𖤓│اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖤓│العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'jx8xj')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *𖤓│اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'jx8xj')..')'..'\n*𖤓│تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_, t..'ٴ𖠧∫ٴ*◐•━━━━━━ DL ━━━━━━━•◐*ٴ𖠧∫○ٴ\n𖤓│[DL𝙀𝙉𝘿_ѕᴏụʀᴄᴇ](t.me/jx8xj) ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⍆ ѕᴏụʀᴄᴇ ᴠᴇɴᴏᴍ',url="t.me/jx8xj"}},
}
local msg_id = msg.id_/2097152/0.5
