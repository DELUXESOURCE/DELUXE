...
io.popen("cd library && wget https://raw.githubusercontent.com/DELUXE-TEAM/DELUXE/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DELUXE-TEAM/Files_DELUXE/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevDELUXEW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevDELUXEW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevDELUXEW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevDELUXEW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevDELUXEW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevDELUXEW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "jx8xj")
...
DELUXE_Msg = 'بعد يرادلك' 
elseif msgs < 400 then 
DELUXE_Msg = 'متوسط' 
elseif msgs < 700 then 
DELUXE_Msg = 'بديت تتفاعل' 
elseif msgs < 1200 then 
DELUXE_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
DELUXE_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
DELUXE_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
DELUXE_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
DELUXE_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
DELUXE_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
DELUXE_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
DELUXE_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
DELUXE_Msg = 'رب التفاعل'  
end 
return DELUXE_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceDELUXE(msg,data) -- بداية العمل 
if msg then
...
local list = database:smembers(bot_id.."DELUXE1:List:Filter"..sl)
...
if not DevDELUXEW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevDELUXEW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,DELUXE_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌁' and DevDELUXEW(msg) then  
...
if text == 'تعطيل التواصل ⌁' and DevDELUXEW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌁' and DevDELUXEW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌁' and DevDELUXEW(msg) then  
...
if text == 'ضع كليشه ستارت ⌁' and DevDELUXEW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✺│ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌁' and DevDELUXEW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✺│تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌁' and DevDELUXEW(msg) then 
...
if text == 'تحديث السورس ⌁' and DevDELUXEW(msg) then 
os.execute('rm -rf DELUXE.lua')
os.execute('wget https://raw.githubusercontent.com/DELUXE-TEAM/DELUXE/main/DELUXE.lua')
send(msg.chat_id_, msg.id_,' *✺│تم تحديث السورس* \n*✺│لديك اخر اصدار لسورس ديلوكس*\n*✺│الاصدار » { 1.0v}*')
dofile('DELUXE.lua')  
end
if text == 'الاصدار ⌁' and DevDELUXEW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✺│اصدار سورس ديلوكس* \n*✺│الاصدار »{ 1.0v}*')
end
if text == 'قناه تحديثات البوت ⌁' and DevDELUXEW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✺│[تحديثات البوت](t.me/jx8xj) \n✺│[قناه السورس](t.me/SNAPfile)')
end
if text == "ضع اسم للبوت ⌁" and DevDELUXEW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✺│ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌁' and DevDELUXEW(msg) then 
...
if text == 'المشتركين ⌁' and DevDELUXEW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✺│المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌁' and DevDELUXEW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✺│الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌁") and DevDELUXEW(msg) then
...
if text == ("قائمه العام ⌁") and DevDELUXEW(msg) then
...
if text == ("قائمه الكتم العام ⌁") and DevDELUXEW(msg) then
...
if text=="اذاعه خاص ⌁" and msg.reply_to_message_id_ == 0 and DevDELUXEW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✺│ارسل الان اذاعتك؟* \n*✺│للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌁" and msg.reply_to_message_id_ == 0 and DevDELUXEW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✺│ارسل الان اذاعتك؟* \n*✺│للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌁" and msg.reply_to_message_id_ == 0 and DevDELUXEW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✺│ارسل الان اذاعتك؟* \n*✺│للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌁" and msg.reply_to_message_id_ == 0  and DevDELUXEW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✺│ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌁" and msg.reply_to_message_id_ == 0  and DevDELUXEW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✺│ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌁' and DevDELUXEW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌁" and DevDELUXEW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌁" and DevDELUXEW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*✺│عدد الكروبات الان » { '..#group..' }'..DELUXEk..''..DELUXE..'*\n*✺│الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevDELUXEW(msg) then
...
usertext = '*\n ✺│اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'jx8xj')..')'
status  = '\n *✺│تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevDELUXEW(msg) then
...
usertext = '\n *✺│اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'jx8xj')..')'
status  = '\n*✺│تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevDELUXEW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevDELUXEW(msg) then
...
local DELUXE1_Msg = database:get(bot_id.."DELUXE1:Add:Filter:Rp2"..text..msg.chat_id_)   
if DELUXE1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✺│اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'jx8xj')..') \n ✺│'..DELUXE1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if DELUXE_Msg and not Special(msg) then  
local DELUXE_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if DELUXE_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✺│العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✺│["..DELUXE_Msg.."] \n")
else
send(msg.chat_id_,0," *✺│العضو :* {["..data.first_name_.."](t.me/jx8xj)}\n✺│["..DELUXE_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✺│عذرا ⇎* {["..data.first_name_.."](t.me/jx8xj)}\n*✺│عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevDELUXEW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevDELUXEW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevDELUXEW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✺│حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevDELUXEW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✺│حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌁" and DevDELUXEW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✺│تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌁$") and DevDELUXEW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✺│حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌁" and DevDELUXEW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌁" and DevDELUXEW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✺│تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌁" and DevDELUXEW(msg) then  
...
database:sadd(bot_id.."DELUXE:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."DELUXE:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_DELUXE = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_DELUXE then 
names_DELUXE = database:smembers(bot_id.."DELUXE:blocname"..msg.chat_id_) or ""
if names_DELUXE and names_DELUXE[1] then 
for i=1,#names_DELUXE do 
if name_DELUXE:match("(.*)("..names_DELUXE[i]..")(.*)") then 
...
database:set(bot_id.."DELUXE:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."DELUXE:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."DELUXE:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."DELUXE:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."DELUXE:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_DELUXEa_new(DELUXE1,DELUXE2)
if DELUXE2 and DELUXE2.first_name_ then 
if DELUXE2.first_name_:match("(.*)"..database:get(bot_id.."DELUXE:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DELUXE:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local DELUXE_nnn = database:get(bot_id.."DELUXE:nump"..msg.chat_id_) or 5
local DELUXE_nnn2 = database:get(bot_id.."DELUXE:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(DELUXE_nnn2) == tonumber(DELUXE_nnn) or tonumber(DELUXE_nnn2) > tonumber(DELUXE_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."DELUXE:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✺│عزيزي >>["..DELUXE2.username_.."](https://t.me/"..(DELUXE2.username_ or "jx8xj")..")\n✺│عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DELUXE:teh"..msg.chat_id_).."} بجانب اسمك\n✺│عدد المحاولات المتبقيه {"..(tonumber(DELUXE_nnn) - tonumber(DELUXE_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_DELUXEa_new)
end
end
...
local DELUXEChengName = database:get(bot_id.."DELUXE:Cheng:Name"..data.id_)
if not data.first_name_ then 
if DELUXEChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DELUXEChengName..']')
database:del(bot_id.."DELUXE:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if DELUXEChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."DELUXE:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local DELUXEChengUserName = database:get(bot_id.."DELUXE:Cheng:UserName"..data.id_)
if not data.username_ then 
if DELUXEChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..DELUXEChengUserName..']')
database:del(bot_id.."DELUXE:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if DELUXEChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."DELUXE:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local DELUXEChengPhoto = database:get(bot_id.."DELUXE:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if DELUXEChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."DELUXE:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if DELUXEChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."DELUXE:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
data = JSON.decode(url)
Text = "𓅛 𝑺𝑶𝑼𝑹𝑪𝑺 𝘋𝘌𝘓𝘜𝘟𝘌 \n\n[✺│ ᴄʜᴀɴɴᴇʟ](http://t.me/jx8xj)\n\n[✺│ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/SD_SN)\n\n[✺│ᴠᴇɴᴏᴍ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/xritc)\n\n[✺│ᴛᴡ ʙᴏᴛ ](http://t.me/IOlIIbot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓅛︙EXP',url="t.me/jx8xj"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'رفع نسخه الاحتياطيه' and DevDELUXEW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, '*✺│بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'jx8xj')..') \n*✺│تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✺│بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'jx8xj')..') \n*✺│تـم قفـل التاك بالكتم* ')
end,nil)   
...
if text == 'تحديث' and DevDELUXEW(msg) then
dofile('DELUXE.lua')  
send(msg.chat_id_, msg.id_, ' *✺│تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevDELUXEW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevDELUXEW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if DELUXESudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevDELUXEW(msg) then
...
if DELUXESudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✺│لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevDELUXEW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevDELUXEW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevDELUXEW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevDELUXEW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevDELUXEW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevDELUXEW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevDELUXEW(msg) then
...
if text == ("مسح المطورين") and DevDELUXEW(msg) then
...
if text == 'الملفات' and DevDELUXEW(msg) then
t = ' *✺│ملفات السورس ديلوكس ↓*\n*◐•━━━━━━ DL ━━━━━━━•◐* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevDELUXEW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DELUXE-TEAM/Files_DELUXE/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *✺│اهلا بك في متجر ملفات ديلوكس*\n*✺│ملفات السورس ↓*\n*◐•━━━━━━ DL ━━━━━━━•◐*\n\n"
local TextE = "\n*◐•━━━━━━ DL ━━━━━━━•◐*\n *✺│علامة تعني { ✓ } ملف مفعل*\n *✺│علامة تعني { ✘ } ملف معطل*\n *✺│قناة سورس ديلوكس ↓*\n".." *✺│*[اضغط هنا لدخول](t.me/jx8xj) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevDELUXEW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/DELUXE-TEAM/Files_DELUXE/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DELUXE.lua')  
else
send(msg.chat_id_, msg.id_," *✺│عذرا الملف لايدعم سورس ديلوكس* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevDELUXEW(msg) then
...
if text == "مسح الملفات" and DevDELUXEW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✺│تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevDELUXEW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevDELUXEW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "jx8xj")
...
function Function_DELUXE(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DELUXE, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_DELUXE, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✺│لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'jx8xj')..')'
status  = '\n*✺│تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✺│اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✺│العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'jx8xj')..')'
...
database:set(bot_id.."DELUXE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."DELUXE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✺│ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."DELUXE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."DELUXE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."DELUXE1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."DELUXE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✺│تم منع الكلمه مع التحذير*")  
database:del(bot_id.."DELUXE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."DELUXE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."DELUXE1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."DELUXE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✺│ارسل الكلمه الان*")  
database:set(bot_id.."DELUXE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DELUXE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."DELUXE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DELUXE1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."DELUXE1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."DELUXE1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."DELUXE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DELUXE1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."DELUXE1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevDELUXEW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✺│تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevDELUXEW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✺│اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'jx8xj')..')'..'\n*✺│تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevDELUXEW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevDELUXEW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديلوكس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ديلوكس')
local DELUXE_Msg = {
'عمغي ??💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..DELUXE_Msg[math.random(#DELUXE_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevDELUXEW(msg) then 
...
if DELUXESudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevDELUXEW(msg) then 
...
if text == ("ردود المطور") and DevDELUXEW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✺│قائمة ردود المطور \n*◐•━━━━━━ DL ━━━━━━━•◐*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevDELUXEW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevDELUXEW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevDELUXEW(msg) then   
...
if text == 'تعطيل المغادره' and DevDELUXEW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'jx8xj')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
DELUXEdx(msg.chat_id_, msg.id_, ' *✺│ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✺│عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✺│عدد المحظورين » ( '..data.kicked_count_..' )*\n*✺│عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevDELUXEW(msg) then
...
{{text = '𓅛 ѕᴏụʀᴄᴇ ᴠᴇɴᴏᴍ', url="t.me/jx8xj"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.id_, t..'ٴ⌁∫ٴ*◐•━━━━━━ DL ━━━━━━━•◐*ٴ⌁∫○ٴ\n✺│[DL𝙀𝙉𝘿_ѕᴏụʀᴄᴇ](t.me/jx8xj) ')
end
...
local Text ='*✺│هاك اسمع ولتدوخنه*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'سـٰٖـ๋͜ــــورسـٰٖـ๋͜ــــ دٰيݪوڪسـٰٖـ๋͜ــــ',url="t.me/jx8xj"}},
}
local msg_id = msg.id_/2097152/0.5
 ...
 *⌁ رابط حذف* [Snspchat](https://accounts.DELUXE.com/accounts/login?continue=https%3A%2F%2Faccounts.DELUXE.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
inline = {
{{text = '𓅛 sᴏᴜʀᴄᴇ 𝗌𝗇𝖺𝗉',url='http://t.me/jx8xj'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ديلوكس')
...
DELUXE = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(DELUXE)
...
--------------------------------------------------------------------------------------------------------------
SourceDELUXE(data.message_,data)
...
------------------------------------------------------------------------
local DELUXEAbot = database:get(bot_id.."DELUXE1:Add:Filter:Rp2"..text..result.chat_id_)   
if DELUXEAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✺│العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✺│["..DELUXEAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local DELUXE1_Msg = database:get(bot_id.."DELUXE1:Add:Filter:Rp2"..text..result.chat_id_)   
if DELUXE1_Msg then
send(msg.chat_id_, msg.id_," ✺│"..DELUXE1_Msg)
