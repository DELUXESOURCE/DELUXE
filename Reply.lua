...
if text == 'مح' then
TextReply = 'بويه مو بوسه شلع خدها كلها احبج'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'هلاو' then
TextReply = 'هـلاوات عمࢪيي شـلونك✨💞'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '😐' then
...
if text == 'باي' then
TextReply = 'وين رآيح كبــدي خ ـليك وينه ɵ̷̥̥᷄ˬɵ̷̥̥᷅'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'عوائل' then
...
if text == '🖐' then
TextReply = 'ويـن ࢪايح عمࢪيي تـعـال خلي نلعب كت تويت💔'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '🙂' then
...
return false
if text == 'تومس' then
TextReply = 'مساعد مطور السورس تومس'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'نايمين' then
...
if text == 'غوراب' then
TextReply = 'هـاذ مـطـوࢪ سـوࢪسـا父 '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'غوراب' then
...
if text == 'احبج' then
TextReply = 'جـذاب تࢪا يـضـحڪ علـيـ༻'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
